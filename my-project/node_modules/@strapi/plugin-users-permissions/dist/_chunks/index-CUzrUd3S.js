...
const indexDbsOttc5 = require("./index-DbsOttc5-fMZ4nmrb.js");
...
const index = require("./index-BQl5bjWF.js");
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = indexDbsOttc5.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(indexDbsOttc5.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(indexDbsOttc5.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-CUzrUd3S.js.map
